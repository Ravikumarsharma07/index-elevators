...
const GantryReqForm = ({
 ...
 const [form, setForm] = useState({
    ...
    const handleSubmit = ()=>{
      ...
      router.push(`https://api.whatsapp.com/send/?phone=%2B917827881632&text=Hi+I+am+interested+in+ordering+Gantry+crane+${form.endCarriage ? "with" : "without"}+end+carriage+of+lifting+capacity+${form.liftingCapacity}-tons+and+rope+height+${form.ropeHeight}-metres+from+Index+Elevators,+please+send+me+the+latest+price.&type=phone_number&app_absent=0`)
    }
  return (
